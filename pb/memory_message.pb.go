...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=gRPC.quickStart.useCpu.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x53, 0x74, 0x61, 0x72, 0x74, 0x2e, 0x75, 0x73, 0x65, 0x43, 0x70, 0x75, 0x22, 0xb7,
	...
	0x75, 0x73, 0x65, 0x43, 0x70, 0x75, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: gRPC.quickStart.useCpu.Memory.Unit
	(*Memory)(nil),   // 1: gRPC.quickStart.useCpu.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: gRPC.quickStart.useCpu.Memory.unit:type_name -> gRPC.quickStart.useCpu.Memory.Unit
