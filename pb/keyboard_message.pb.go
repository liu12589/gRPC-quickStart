...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=gRPC.quickStart.useCpu.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x67, 0x52, 0x50, 0x43, 0x2e, 0x71,
	...
	0x67, 0x52, 0x50, 0x43, 0x2e, 0x71, 0x75, 0x69, 0x63, 0x6b, 0x53, 0x74, 0x61, 0x72, 0x74, 0x2e,
	0x75, 0x73, 0x65, 0x43, 0x70, 0x75, 0x2e, 0x4b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e,
...
var file_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: gRPC.quickStart.useCpu.Keyboard.Layout
	(*Keyboard)(nil),     // 1: gRPC.quickStart.useCpu.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: gRPC.quickStart.useCpu.Keyboard.layout:type_name -> gRPC.quickStart.useCpu.Keyboard.Layout
