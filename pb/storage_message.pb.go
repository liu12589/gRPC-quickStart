...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=gRPC.quickStart.useCpu.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x16, 0x67, 0x52, 0x50, 0x43, 0x2e, 0x71, 0x75,
	0x69, 0x63, 0x6b, 0x53, 0x74, 0x61, 0x72, 0x74, 0x2e, 0x75, 0x73, 0x65, 0x43, 0x70, 0x75, 0x1a,
	...
	0x0e, 0x32, 0x26, 0x2e, 0x67, 0x52, 0x50, 0x43, 0x2e, 0x71, 0x75, 0x69, 0x63, 0x6b, 0x53, 0x74,
	0x61, 0x72, 0x74, 0x2e, 0x75, 0x73, 0x65, 0x43, 0x70, 0x75, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61,
	...
	0x61, 0x72, 0x74, 0x2e, 0x75, 0x73, 0x65, 0x43, 0x70, 0x75, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: gRPC.quickStart.useCpu.Storage.Driver
	(*Storage)(nil),     // 1: gRPC.quickStart.useCpu.Storage
	(*Memory)(nil),      // 2: gRPC.quickStart.useCpu.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: gRPC.quickStart.useCpu.Storage.driver:type_name -> gRPC.quickStart.useCpu.Storage.Driver
	2, // 1: gRPC.quickStart.useCpu.Storage.memory:type_name -> gRPC.quickStart.useCpu.Memory
